...
function searchByName() {
  const mealName = document.getElementById('name-input').value;
...
function firstLetter() {
    const letter = document.getElementById('first-letter-input').value;
...
document.getElementById('name-input').addEventListener('input', searchByName);
document.getElementById('first-letter-input').addEventListener('input', firstLetter);
